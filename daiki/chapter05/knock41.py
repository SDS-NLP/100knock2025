...
few_shot_examples = """日本の近代化に関連するできごとについて述べた次のア～ウを年代の古い順に正しく並べよ。
...
problem_40 = """"9世紀に活躍した人物に関係するできごとについて述べた次のア～ウを年代の古い順に正しく並べよ。
...
if response.status_code == 200:
    res = response.json()
    answer = res["candidates"][0]["content"]["parts"][0]["text"].strip()  # strip()で改行除去
    print("回答（4-shot推論）:")
    print(answer)
else:
